...
from meta_ads_country_conversions import main as meta_ads_main
...
with DAG(
    dag_id="meta_ads_country_conversions_raw_dag",
    default_args=default_args,
    description="Incrementally extract and load Meta Ads Country Conversions data into BigQuery",
    ...
    run_incremental_extraction = PythonOperator(
        task_id="extract_and_load_meta_ads_country_conversions_raw_data",
