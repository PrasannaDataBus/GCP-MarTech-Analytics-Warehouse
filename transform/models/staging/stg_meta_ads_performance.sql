...
renamed AS (
    SELECT
        ...
        FARM_FINGERPRINT(CONCAT(CAST(source.date AS STRING), CAST(ad_id AS STRING))) as id,
        ...
        SAFE_CAST(source.cpm AS FLOAT64) as cpm,
        ...
        SAFE_CAST(source.reach AS INT64) as reach, -- Meta Specific
        SAFE_CAST(source.frequency AS FLOAT64) as frequency, -- Meta Specific
