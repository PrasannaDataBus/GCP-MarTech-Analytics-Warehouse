...
renamed AS (
    SELECT
        -- 1. Generate Unique ID (Using correct 'date' column)
        ...
        -- Mapping "AdSet" (Meta) to "Ad Group" (Google/Standard)
